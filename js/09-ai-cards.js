  ...
  function buildHelp() {
    ...
    page.innerHTML =
      ...
      '<div class="faq-section">' +
        ...
        _faq('Сколько фото можно распознавать?', 'На Free — 5 фото в день. Лимит сбрасывается каждые сутки. В Premium лимит выше в зависимости от тарифа.') +
        _faq('Что входит в Premium?', 'Больше фото-распознаваний в день, безлимит AI-нутрициолога (у Free — 3 в месяц), безлимит планов питания и рецептов, PDF-отчёты до 90 дней, приоритет в техподдержке. Все тарифы: Basic 449₽, Standard 1199₽, Premium 3990₽/мес.') +
        _faq('Как добавить тренировку?', 'Вкладка «Спорт» → выбери упражнение или введи своё → укажи длительность. Сожжённые калории автоматически прибавляются к дневной норме в Дневнике.') +
