  ...
  function buildHelp() {
    ...
    page.innerHTML =
      ...
      '<div class="faq-section">' +
        ...
        _faq('Что входит в платные тарифы?', 'Больше фото-распознаваний в день, расширенный лимит AI-нутрициолога и планов питания, безлимитные рецепты (на Premium), полный PDF-отчёт с графиками на 30 и 90 дней, приоритет в техподдержке.') +
