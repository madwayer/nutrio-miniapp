...
(function(){
  ...
  var EXT = {
    ru: {
      ...
      help_a3:"До 80 фото-распознаваний в день, безлимит голосовых, AI-нутрициолога, генератор рецептов, планировщик питания, PDF-отчёты до 90 дней, без рекламы.",
    ...
    en: {
      ...
      help_a3:"Up to 80 photo recognitions per day, unlimited voice input, AI nutritionist, recipe generator, meal planner, PDF reports up to 90 days, no ads.",
